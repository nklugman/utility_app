...
mymap = map_display.GoogleMapPlotter.from_geocode("Nairobi") ##Setting the center of the map displayed.
for point in id_list:
    mymap.polygon(map_display.get_long_path(point), map_display.get_lat_path(point))
