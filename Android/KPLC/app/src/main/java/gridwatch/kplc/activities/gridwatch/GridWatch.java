...
import static gridwatch.kplc.activities.config.SensorConfig.LOCATION_TIMEOUT_IN_SECONDS;
    ...
    public void run() {
        ...
        gridwatch_stream.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Action1<JSONObject>() {
                    @Override
                    public void call(final JSONObject o) {
        ...
        try {
            ...
            if (mWifi.isWifiEnabled() != false) {
                ...
                for (int i = 0; i < results.size(); i++) {
                    ...
                    to_ret.put(a.SSID, a.BSSID + "," + String.valueOf(a.level));
                }
                return to_ret;
            } else {
               return null;
