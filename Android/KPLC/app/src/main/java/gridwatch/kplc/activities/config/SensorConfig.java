...
public class SensorConfig {
    ...
    public final static String recordingFileTmpName = "tx_tmp.raw";
    public final static String recordingFolder = "tx_audio";
    ...
    public static final long AUDIO_INTERVAL = 1000*30;
